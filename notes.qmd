...
Be careful that the alternative hypothesis is not that all means are different. The opposite of all means being equal (𝐻0
) is that at least one mean is different from the others (𝐻1
).
